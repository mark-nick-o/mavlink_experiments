...
struct camImageCaptured_t
{
   ...
   std::char file_url[205];			             // URL of image taken. Either local storage or http://foo.jpg if camera provides an HTTP interface.
   std::uint8_t error;
};
...
enum mavSendState_e : std::int32_t
{
    ...
    DO_CAM_SEND_TRIGG,
    DO_CAM_SENT_TRIGG,
    DO_CAM_SEND_TRACK_POINT,
    DO_CAM_SENT_TRACK_POINT,
    DO_CAM_SEND_TRACK_RECT,
    DO_CAM_SENT_TRACK_RECT,
    DO_CAM_SEND_TRACK_STOP,
    DO_CAM_SENT_TRACK_STOP,
    DO_SEND_CANCEL,
