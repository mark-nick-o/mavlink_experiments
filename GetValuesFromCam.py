...
if __name__ == '__main__':
    ...
    #
    while True:
        p0 = multiprocessing.Process(target=run_process_messages_from_connection, args=(frame, cID,)).start()   
        p1 = multiprocessing.Process(target=manageAlphaCameraExpro, args=(mySonyCamNo1, gcsWrites2Sony, expro,)).start()
        p3 = multiprocessing.Process(target=manageAlphaCameraAperture, args=(mySonyCamNo1, gcsWrites2Sony, aper,)).start()
        p5 = multiprocessing.Process(target=manageAlphaCameraFocusData, args=(mySonyCamNo1, gcsWrites2Sony, focusdata, focusarea,)).start()
        p7 = multiprocessing.Process(target=manageAlphaCameraIso, args=(mySonyCamNo1, gcsWrites2Sony, iso,)).start()
        p9 = multiprocessing.Process(target=manageAlphaCameraShutSpd, args=(mySonyCamNo1, gcsWrites2Sony, shut_sp,)).start()
        p11 = multiprocessing.Process(target=manageAlphaWhiteBala, args=(mySonyCamNo1, gcsWrites2Sony, whitebal,)).start()
        p13 = multiprocessing.Process(target=manageAlphaCameraStillCap, args=(mySonyCamNo1, gcsWrites2Sony, stillcap,)).start()
        p1.join(5)
        p3.join(5)
        p5.join(5)
        p7.join(5)
        ...
        p11.join(5)  
        p13.join(5)     
        p2 = multiprocessing.Process(target=sendMavExpro, args=(mySonyCamNo1, expro, cID,)).start()
        p4 = multiprocessing.Process(target=sendMavAper, args=(mySonyCamNo1, aper, cID,)).start()
        p6 = multiprocessing.Process(target=sendMavFocusData, args=(mySonyCamNo1, focusdata, focusarea, cID, )).start()
        p8 = multiprocessing.Process(target=sendMavIso, args=(mySonyCamNo1, iso, cID, )).start()
        p10 = multiprocessing.Process(target=sendMavShutSpd, args=(mySonyCamNo1, shut_sp, cID, )).start()
        p12 = multiprocessing.Process(target=sendMavWhiteBala, args=(mySonyCamNo1, shut_sp, cID, )).start()
        p14 = multiprocessing.Process(target=sendMavStillCap, args=(mySonyCamNo1, shut_sp, cID, )).start()   
        p2.join(5)
        p4.join(5)
        p6.join(5)
        p8.join(5)
