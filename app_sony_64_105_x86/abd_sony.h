...
#define __abd_sony_h
    ...
    CrInt8 SetApertureArgsInt(int selected_index);
    CrInt8 SetWhiteBalanceArgsInt(int selected_index);
    CrInt8 SetFocusAreaArgsInt(int selected_index);
    CrInt8 SetFocusModeArgsInt(int selected_index);
    CrInt8 SetStillCaptureModeArgsInt(int selected_index);
    CrInt8 SetExposureProgramModeArgsInt(int selected_index);
    CrInt8 SetShutterSpeedArgsInt(int selected_index);
    CrInt8 SetIsoArgsInt(int selected_index);
