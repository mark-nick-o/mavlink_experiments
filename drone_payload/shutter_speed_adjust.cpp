/*   This is the shutter spped adjustment which will be used in the full version using boost 
     at present i'm linking only the poco library so this will be added later
