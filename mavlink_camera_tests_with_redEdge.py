...
class MAVFrame():
    ...
    def mavlink_send_param_value(self, the_connection):
        ...
        try:
            ...
            print("Failed to send param value message : %s" % (err_msg))
            ret = False
        d=struct.unpack('f', struct.pack('I', 31))[0]
        try:
            the_connection.mav.param_value_send(
            ...
            print("Failed to send param value message : %s" % (err_msg))
            ret = False
        d=struct.unpack('f', struct.pack('I', 131))[0]
        try:
            the_connection.mav.param_value_send(
            ...
            print("Failed to send param value message : %s" % (err_msg))
            ret = False
        d=struct.unpack('f', struct.pack('I', 8))[0]
        try:
            the_connection.mav.param_value_send(
        ...
        try:
            ...
            print("Failed to send param value message : %s" % (err_msg))
            ret = False
        d=struct.unpack('f', struct.pack('I', 6))[0]
        try:
            the_connection.mav.param_value_send(
    ...
    def process_messages_from_connection(self, fra, the_connection, redCam=0):
        ...
        while loop >= 1:
            ...
            if msg.get_type() == "BAD_DATA":
                ...
                self.mavlink_send_param_value(the_connection)
                print("PARAM_SET was sent")
                #exit(97)
            elif msg.get_type() == 'PARAM_EXT_SET':
                self.mavlink_send_param_value(the_connection)
                print("PARAM_EXT_SET was sent")
                #exit(96)
